...
object WordCount {
  def main(args: Array[String]) {
    ...
    val env = StreamExecutionEnvironment
      ...
      .setStateBackend(new FsStateBackend("file:///home/dana", true))
    ...
    val kafkaConsumer = new FlinkKafkaConsumer[String]("inputword", new SimpleStringSchema, kafkaProperties)
